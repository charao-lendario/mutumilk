  ...
  return <Sidebar className={collapsed ? "w-14" : "w-60"} collapsible="icon">
      ...
      <SidebarFooter className="border-t p-4">
        <div className="space-y-2">
          {!collapsed && user && <div className="px-3 py-2 text-xs text-muted-foreground truncate">
              {user.email}
            </div>}
          <Button onClick={signOut} variant="ghost" className="w-full justify-start" size={collapsed ? "sm" : "default"}>
